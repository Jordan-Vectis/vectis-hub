// The Auction Calendar — the Upcoming and View Results tabs, the search, the date picker and the
// list. One copy, used by the built-in /auctions page and by the page editor's "Auction calendar"
// live block (2026-09-24). Moved here unchanged from auctions/page.tsx.
...
export type CalendarParams = { search?: string; tab?: string; type?: string; page?: string }

export default async function AuctionCalendar({ sp, title = "Auction Calendar" }: { sp: CalendarParams; title?: string }) {
  const { search, tab, type, page } = sp
