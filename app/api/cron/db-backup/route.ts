...
async function fetchTable(tableName: string): Promise<any[] | null> {
  try {
    switch (tableName) {
      ...
      case "inductionSlides":        return await prisma.inductionSlide.findMany()
      case "inductionForms":         return await prisma.inductionForm.findMany()
      case "inductionFormItems":     return await prisma.inductionFormItem.findMany()
      case "inductionSignatures":    return await prisma.inductionSignature.findMany()
