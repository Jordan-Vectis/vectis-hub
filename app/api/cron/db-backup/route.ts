...
export async function runBackup(): Promise<{
  ...
  const tables = {
    ...
    bcCatalogueDays:        await safe(() => prisma.bCCatalogueDay.findMany()),
    bcCatalogueEntries:     await safe(() => prisma.bCCatalogueEntry.findMany()),
    bcPackingDays:          await safe(() => prisma.bCPackingDay.findMany()),
    bcPackingEntries:       await safe(() => prisma.bCPackingEntry.findMany()),
    ...
    warehouseItems:         await safe(() => prisma.warehouseItem.findMany()),
    warehouseSyncLogs:      await safe(() => prisma.warehouseSyncLog.findMany()),
