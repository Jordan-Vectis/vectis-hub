    ...
    <div className="p-6">
      ...
      <div className="flex items-start justify-between gap-4 flex-wrap mb-5">
        ...
        <div className="flex items-center gap-2 flex-wrap">
          <button onClick={() => startTransition(async () => { await createTestITJob("text") })} disabled={isPending} className="bg-gray-100 dark:bg-gray-800 hover:bg-gray-200 dark:hover:bg-gray-700 text-gray-500 dark:text-gray-400 text-base font-semibold px-4 py-3 rounded-xl transition-colors disabled:opacity-50" title="Create a sample plain-text email for testing">🧪 Test plain</button>
          <button onClick={() => startTransition(async () => { await createTestITJob("html") })} disabled={isPending} className="bg-gray-100 dark:bg-gray-800 hover:bg-gray-200 dark:hover:bg-gray-700 text-gray-500 dark:text-gray-400 text-base font-semibold px-4 py-3 rounded-xl transition-colors disabled:opacity-50" title="Create a sample HTML email for testing">🧪 Test HTML</button>
