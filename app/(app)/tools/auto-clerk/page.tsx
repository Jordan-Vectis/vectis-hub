        ...
        <div className="bg-white dark:bg-[#1C1C1E] border border-gray-200 dark:border-gray-700 rounded-xl p-5 space-y-4">
          ...
          <div className="bg-blue-50 dark:bg-blue-950/30 rounded-lg p-4 border border-blue-200 dark:border-blue-900">
            ...
            <ul className="text-xs text-blue-900 dark:text-blue-200 space-y-1.5">
              ...
              <li><strong>Catches the other platform up to the exact amount</strong> (not one increment at a time, so it can&apos;t lag): on Saleroom by typing into the box next to A, on Vectis by setting the Asking bid and pressing the Saleroom button. An online bid that appears on both by itself gets no press at all — and while bids are still landing it <strong>waits for the flurry to finish</strong> rather than clicking into the middle of it.</li>
              <li><strong>Every catch-up is checked against its target.</strong> If a real bid slips in between setting the amount and pressing, the press can land at the platform&apos;s new asking — a bid nobody made. The clerk reads the top row to tell its own press from a customer&apos;s, undoes its own phantom on the spot, and never mirrors it to the other side.</li>
              <li><strong>The closing clock only runs while the screens agree.</strong> If one platform jumps ahead, the Fair Warning countdown is held until the other is caught up, and the quiet time starts afresh from the moment they&apos;re level.</li>
              <li><strong>The status box names who&apos;s winning.</strong> “Saleroom £45 · Vectis £45 · Vectis bidder winning” — tracked from which platform each genuine bid arrived on and how ties were resolved, so you can see at a glance whose lot it currently is.</li>
              <li><strong>The bid-list wording is editable on the setup screen.</strong> The clerk tells its own presses from real bidders by the words on the lists — “Saleroom” on Vectis, “ROOM” and “INTERNET” on the Saleroom. Those three are settings now (commas for alternatives), so if a platform ever changes its labels it&apos;s a ten-second edit, not a code change.</li>
              <li><strong>It can prove the money is real.</strong> Draw a box round each screen&apos;s whole bid list and, before Fair Warning and again before the hammer, it checks the standing price traces to a genuine bidder&apos;s row on at least one platform — not just the clerk&apos;s own mirror presses. A price nobody real bid is unwound to the best figure a real bidder actually holds. Best-effort: an unreadable list skips the check and says so in the log, it never blocks a sale by itself.</li>
