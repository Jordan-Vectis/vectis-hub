...
export default function DraftsTab() {
  ...
  return (
    <div className="flex-1 overflow-hidden flex">
      ...
      {/* ── List ─────────────────────────────────────────────────────────── */}
      <div className="w-80 border-r border-gray-200 dark:border-gray-800 overflow-y-auto bg-gray-50 dark:bg-gray-950 shrink-0">
        ...
        <div className="divide-y divide-gray-200 dark:divide-gray-900">
          {drafts.map(d => (
            <button key={d.id} onClick={() => pick(d)}
              className={`w-full text-left px-4 py-3 hover:bg-gray-200 dark:hover:bg-gray-900 transition-colors ${selected?.id === d.id ? "bg-gray-100 dark:bg-gray-900" : ""}`}>
          ...
          <div className="p-6 space-y-4">
            <div className="flex items-center justify-between gap-3 flex-wrap">
              <input value={editTitle} onChange={e => setEditTitle(e.target.value)}
                className="flex-1 min-w-[200px] bg-gray-100 dark:bg-gray-900 border border-gray-300 dark:border-gray-700 rounded-lg px-3 py-2 text-sm text-gray-900 dark:text-white focus:outline-none focus:border-pink-500" />
              <select value={editStatus} onChange={e => setEditStatus(e.target.value)}
                className="bg-gray-100 dark:bg-gray-900 border border-gray-300 dark:border-gray-700 rounded-lg px-3 py-2 text-sm text-gray-900 dark:text-white focus:outline-none focus:border-pink-500">
            ...
            <div>
              ...
              <input value={editPublishedUrl} onChange={e => setEditPublishedUrl(e.target.value)}
                ...
                className="w-full bg-gray-100 dark:bg-gray-900 border border-gray-300 dark:border-gray-700 rounded-lg px-3 py-2 text-sm text-gray-900 dark:text-white placeholder-gray-500 focus:outline-none focus:border-pink-500" />
            </div>
            ...
            <div className="flex items-center gap-2 flex-wrap">
              ...
              <button onClick={() => copyAs("plain")} className="text-xs bg-white dark:bg-gray-800 hover:bg-gray-200 dark:hover:bg-gray-700 text-gray-700 dark:text-gray-200 px-3 py-1.5 rounded-lg">{copied === "plain" ? "✓ Copied!" : "Copy Plain"}</button>
              <button onClick={() => copyAs("html")} className="text-xs bg-white dark:bg-gray-800 hover:bg-gray-200 dark:hover:bg-gray-700 text-gray-700 dark:text-gray-200 px-3 py-1.5 rounded-lg">{copied === "html" ? "✓ Copied!" : "Copy HTML"}</button>
            </div>
            ...
            <div>
              ...
              <textarea value={editContent} onChange={e => setEditContent(e.target.value)} rows={18}
                className="w-full bg-gray-100 dark:bg-gray-900 border border-gray-300 dark:border-gray-700 rounded-lg px-3 py-2 text-sm text-gray-700 dark:text-gray-200 font-mono focus:outline-none focus:border-pink-500" />
            </div>

            <div>
              <p className="text-xs text-gray-600 dark:text-gray-400 mb-1">Preview</p>
              <div className="bg-gray-100 dark:bg-gray-900 border border-gray-300 dark:border-gray-700 rounded-lg p-5 prose prose-invert prose-sm max-w-none text-gray-700 dark:text-gray-200
