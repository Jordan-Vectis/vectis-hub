...
- WHOLE NUMBERS (Jordan, 2026-09-11 - "Class 37" was bringing up every Class 373): a word that starts or ends with a digit may not have more digits glued on at that end - "37" finds Class 37, 37/5, No.37, never 373/3714/37417; letters may touch ("3514" still finds R3514). A tick in the filters, ON by default (his choice: a toggle, not typing quotes), with a note under the results. ILIKE first pass + a ~* pattern for the edges, measured no slower (class 37: 2.4 s, 13,414 -> 3,406 lots). ID fields stay a plain contains.
