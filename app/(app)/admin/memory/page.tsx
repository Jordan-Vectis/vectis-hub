...
- ⚠ The bulk actions are SELECTION-SCOPED: they only appear once lots are ticked, so the toolbar looks like it has no AI-exclude button until you select something. Jordan asked for mass AI-exclude on 2026-08-14 when it already existed for this reason.
