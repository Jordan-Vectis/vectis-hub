...
type Tab = "counters" | "roster" | "champdb"

// The single MCOC section — Counters, My Roster, and the Champion DB as tabs.
// Counters/Roster stay mounted (hidden when inactive) so switching keeps state;
// the Champion DB mounts on demand (it fetches).
