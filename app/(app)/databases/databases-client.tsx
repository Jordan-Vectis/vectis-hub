    ...
    <div className="min-h-screen bg-gray-50 dark:bg-[#0D0D0F] text-gray-100">
      <div className="max-w-7xl mx-auto px-4 py-6">
        ...
        <div className="flex gap-1 border-b border-gray-800 overflow-x-auto scrollbar-none">
          ...
          <Link href="/databases/departments" className="px-4 py-2.5 text-sm font-medium whitespace-nowrap border-b-2 border-transparent text-gray-500 hover:text-gray-300 transition-colors">Departments ↗</Link>
        </div>
